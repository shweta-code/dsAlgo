...
public class LowestCommonAncestorMethodOne {
    ...
    public static void main(String[] args) {
        ...
        LowestCommonAncestorMethodOne lowestCommonAncestorMethodOne = new LowestCommonAncestorMethodOne();
        final Node node = lowestCommonAncestorMethodOne.find(root, 5, 6);
