...
public class FindRightHeightOfEachNodeInBinaryTreeTest {

    private final FindRightHeightOfEachNodeInBinaryTree rightHeight = new FindRightHeightOfEachNodeInBinaryTree();

    @Test
    public void test1() {

        Map<Integer, Integer> maxHeightOfLeftSubTree = rightHeight.findMaxHeightOfLeftSubTree(createTree1());
    ...
    public void test2() {
        ...
        Map<Integer, Integer> maxHeightOfLeftSubTree = rightHeight.findMaxHeightOfLeftSubTree(createTree2());
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(1));
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(5));
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(6));
    ...
    public void test3() {
        ...
        Map<Integer, Integer> maxHeightOfLeftSubTree = rightHeight.findMaxHeightOfLeftSubTree(createTree3());
        Assert.assertEquals(5, (int) maxHeightOfLeftSubTree.get(1));
        Assert.assertEquals(3, (int) maxHeightOfLeftSubTree.get(2));
        Assert.assertEquals(1, (int) maxHeightOfLeftSubTree.get(3));
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(4));
        Assert.assertEquals(2, (int) maxHeightOfLeftSubTree.get(5));
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(6));
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(7));
        Assert.assertEquals(1, (int) maxHeightOfLeftSubTree.get(8));
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(9));
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(10));
        Assert.assertEquals(0, (int) maxHeightOfLeftSubTree.get(11));
